...
Feel free to follow along with the challenge! Each day's folder will contain:
- ✅ A `.c` file with the code
- 📝 A short explanation or comment section
- 📌 Possible improvements or future ideas
